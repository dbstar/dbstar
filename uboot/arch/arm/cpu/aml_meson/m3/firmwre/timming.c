...
//533~400 Elpida
#define DDR3_9_9_9
//#define DDR3_9_9_9_DATA8
//#define DDR3_8_8_8_1066
//#define DDR3_7_7_7_1066
//#define DDR3_533
//#define SAMSUNG
//#define DDR3_336
//#define Elpida
static struct ddr_set __ddr_setting={
...
#elif defined(DDR3_336)
                    .cl             =   8,
                    .t_faw          =  30,
                    .t_mrd          =   4,
                    .t_1us_pck      = 84,//133,//533,
                    .t_100ns_pck    =  9,//13,//53,
                    .t_init_us      = 511,
                    .t_ras          =  24,//20,
                    .t_rc           =  33,//28,
         ...
         .init_pctl=init_pctl_ddr3
                    ...
                    .t_rcd          =   9,
                    .t_refi_100ns   =  39,
                    .t_rfc          = 107,  //2Gb:107, 4Gb:174~200, 1Gb:74
                    .t_rp           =   9,
                    .t_rrd          =   5,   //8bit:6 or 4, 16bit:5
                    .t_rtp          =   5,
                    .t_wr           =  10,
                    .t_wtr          =   5,
                    .t_xp           =   4,
...
#elif defined(DDR3_9_9_9_DATA8)
                    .cl             =   9,
                    .t_faw          =  20,   //8bit:20, 16bit:30
                    .t_mrd          =   4,
                    .t_1us_pck      = 132,
                    .t_100ns_pck    =  14,
                    .t_init_us      = 511,
         ...
         .ddr_pll_cntl=0x0011022c,
         .ddr_clk=528,
         //.ddr_pll_cntl=0x0011022d,
         //.ddr_clk=540,
         //.ddr_pll_cntl=0x0011022b,
         //.ddr_clk=516,
         //.ddr_pll_cntl=0x00110227,
         //.ddr_clk=468,
         //.ddr_pll_cntl=0x00110231,
         //.ddr_clk=588, //need test
         //.ddr_pll_cntl=0x00110233,
         //.ddr_clk=612, //need test
         //.ddr_pll_cntl=0x00110235,
         //.ddr_clk=636, //need test
         //.ddr_pll_cntl=0x00110237,
         //.ddr_clk=660,  // not stable
         .ddr_ctrl= (0 << 24 ) |    //pctl_brst 4,
                    (0xff << 16) |  //reorder en for the 8 channel.
                    (0 << 15 ) |     // pctl16 mode = 0.  pctl =   32bits data pins
                    (0 << 14 ) |     // page policy = 0.
         ...
         .init_pctl=init_pctl_ddr3
...
#elif defined(DDR3_8_8_8_1066)
                    .cl             =   8,
                    .t_faw          =  27,   //8bit:20, 16bit:27
                    .t_mrd          =   4,
                    .t_1us_pck      = 132,
                    .t_100ns_pck    =  14,
                    .t_init_us      = 511,
                    ...
                    .t_rcd          =   8,
                    .t_refi_100ns   =  39,
                    .t_rfc          =  86,   //4Gb:160, 2Gb:86, 1Gb:59
                    .t_rp           =   8,
                    .t_rrd          =   6,   //8bit:6 or 4, 16bit:6
                    .t_rtp          =   4,
                    .t_wr           =   8,
                    .t_wtr          =   4,
                    .t_xp           =   4,
         ...
         .init_pctl=init_pctl_ddr3
                    ...
                    .t_rcd          =   7,
                    .t_refi_100ns   =  39,
                    .t_rfc          = 139,   //4Gb:139~160, 2Gb:86, 1Gb:59
                    .t_rp           =   7,
                    .t_rrd          =   6,   //8bit:6 or 4, 16bit:6
                    .t_rtp          =   4,
                    .t_wr           =   8,
...
={
	...
	.demod_pll400m_cntl=(1<<9)	| //n 1200=xtal*m/n 
			(50<<0),	//m 50*24
	.spi_setting=0xeae6e,//.spi_setting=0xea949,

	.nfc_cfg=(((0)&0xf)<<10) | (0<<9) | (0<<5) | 5,
	.sdio_cmd_clk_divide=7,
