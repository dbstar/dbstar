...
public class AlertController {
	...
	public AlertController(Context context, DialogInterface di, Window window) {
		...
		// R.styleable.GDAlertDialog);
		//
		// mAlertDialogLayout =
		// a.getResourceId(R.styleable.GDAlertDialog_layout,
	...
	private void setBackground(LinearLayout topPanel,
		...
		int fullDark = a.getResourceId(R.styleable.GDAlertDialog_fullDark,
				R.drawable.popup_full_dark);
		int topDark = a.getResourceId(R.styleable.GDAlertDialog_topDark,
				R.drawable.popup_top_dark);
		int centerDark = a.getResourceId(R.styleable.GDAlertDialog_centerDark,
				R.drawable.popup_center_dark);
		int bottomDark = a.getResourceId(R.styleable.GDAlertDialog_bottomDark,
				R.drawable.popup_bottom_dark);
		int fullBright = a.getResourceId(R.styleable.GDAlertDialog_fullBright,
				R.drawable.popup_full_bright);
		int topBright = a.getResourceId(R.styleable.GDAlertDialog_topBright,
				R.drawable.popup_top_bright);
		int centerBright = a.getResourceId(
				R.styleable.GDAlertDialog_centerBright,
				R.drawable.popup_center_bright);
		int bottomBright = a.getResourceId(
				R.styleable.GDAlertDialog_bottomBright,
				R.drawable.popup_bottom_bright);
		int bottomMedium = a.getResourceId(
				R.styleable.GDAlertDialog_bottomMedium,
	...
	public static class AlertParams {
		...
		// CheckedTextView text = (CheckedTextView)
		...
		// : new ArrayAdapter<CharSequence>(mContext, layout, R.id.text1,
		// mItems);
		// } else {
