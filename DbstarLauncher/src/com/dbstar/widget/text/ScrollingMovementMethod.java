...
package com.dbstar.widget.text;
...
public class ScrollingMovementMethod extends BaseMovementMethod implements MovementMethod {
	...
	public ScrollingMovementMethod(boolean scrollByPage) {
		super(scrollByPage);
	}
    ...
    public static MovementMethod getInstance(boolean scrollByPage) {
        if (sInstance == null)
            sInstance = new ScrollingMovementMethod(scrollByPage);
