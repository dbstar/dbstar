 ...
 */
public class GDHorizontalScrollView extends FrameLayout {
    private static final int ANIMATED_SCROLL_GAP = 0;//ScrollView.ANIMATED_SCROLL_GAP;

    private static final float MAX_SCROLL_FACTOR = 1;//ScrollView.MAX_SCROLL_FACTOR;
    ...
    public GDHorizontalScrollView(Context context) {
        this(context, null);
    }

//    public GDHorizontalScrollView(Context context, AttributeSet attrs) {
...
//    }
    ...
    public GDHorizontalScrollView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.GDHorizontalScrollView);

        setFillViewport(a.getBoolean(R.styleable.GDHorizontalScrollView_fillViewport, false));
    ...
    protected void onOverScrolled(int scrollX, int scrollY,
        ...
        if (!mScroller.isFinished()) {
            //mScrollX = scrollX;
        	setScrollX(scrollX);
            setScrollY(scrollY);// mScrollY = scrollY;
...
//            } return false;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(GDHorizontalScrollView.class.getName());
...
//            }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(GDHorizontalScrollView.class.getName());
