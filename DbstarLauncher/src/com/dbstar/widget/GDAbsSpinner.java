 ...
 */
public abstract class GDAbsSpinner extends GDAdapterView<SpinnerAdapter> {
    static final String TAG = "GDAbsSpinner";
    ...
    public GDAbsSpinner(Context context) {
        super(context);
        initAbsSpinner();
    }

    public GDAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GDAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
...
//                }
    ...
    void recycleAllViews() {
        ...
        final GDAbsSpinner.RecycleBin recycleBin = mRecycler;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            recycleBin.put(index % getCount(), v);
        }  
    }
    ...
    public void setSelectionByForce(int position) {
        setNextSelectedPositionInt(position);
        requestLayout();
        invalidate();
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(GDAbsSpinner.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(GDAbsSpinner.class.getName());
    }
