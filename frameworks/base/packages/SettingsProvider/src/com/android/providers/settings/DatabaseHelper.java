...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
			...
			loadStringSetting(stmt, "lockscreen.options",R.string.def_facelock_option);
	String config_defaultIME=mContext.getResources().getString(com.android.internal.R.string.config_defaultIME);
