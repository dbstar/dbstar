...
static struct resource smartcard_resource[] = {
	[0] = {
		.start = (GPIOX_bank_bit0_31(22)<<16)|GPIOX_bit_bit0_31(22),
		.end   = (GPIOX_bank_bit0_31(22)<<16)|GPIOX_bit_bit0_31(22),
		.flags = IORESOURCE_MEM,
		.name  = "smc0_power"
	},
	[1] = {
...
static void __init device_dmx_pinmux_setting(void)
{
}
static void __init device_smc_pinmux_setting(void)
{
    SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (0xf<<14));
}
...
static void __init device_pinmux_init(void )
{
    ...
    uart_set_pinmux(UART_PORT_A,UART_A_GPIO_X13_X14_STD);
    /*pinmux of eth*/
    eth_pinmux_init();
    aml_i2c_init();

#if defined(CONFIG_AM_DVB)
	device_smc_pinmux_setting();
	device_dmx_pinmux_setting();
#endif
