...
#include "dbstarplayer/src/bookmodel/BookModel.h"
#include "dbstarplayer/src/formats/FormatPlugin.h"
#include "dbstarplayer/src/library/Library.h"
#include "dbstarplayer/src/library/Author.h"
#include "dbstarplayer/src/library/Book.h"
#include "dbstarplayer/src/library/Tag.h"
#include "dbstarplayer/src/library/UID.h"
...
extern "C"
JNIEXPORT jboolean JNICALL Java_com_media_dbstarplayer_formats_NativeFormatPlugin_readMetaInfoNative(JNIEnv* env, jobject thiz, jobject javaBook) {
...
extern "C"
JNIEXPORT void JNICALL Java_com_media_dbstarplayer_formats_NativeFormatPlugin_readUidsNative(JNIEnv* env, jobject thiz, jobject javaBook) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return;
	}
...
extern "C"
JNIEXPORT void JNICALL Java_com_media_dbstarplayer_formats_NativeFormatPlugin_detectLanguageAndEncodingNative(JNIEnv* env, jobject thiz, jobject javaBook) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return;
	}
...
extern "C"
JNIEXPORT jboolean JNICALL Java_com_media_dbstarplayer_formats_NativeFormatPlugin_readModelNative(JNIEnv* env, jobject thiz, jobject javaModel) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return JNI_FALSE;
	}
...
extern "C"
JNIEXPORT void JNICALL Java_com_media_dbstarplayer_formats_NativeFormatPlugin_readCoverInternal(JNIEnv* env, jobject thiz, jobject file, jobjectArray box) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return;
	}
