...
JavaClass AndroidUtil::Class_ZLibrary("com/media/zlibrary/core/library/ZLibrary");
JavaClass AndroidUtil::Class_ZLFile("com/media/zlibrary/core/filesystem/ZLFile");
JavaClass AndroidUtil::Class_ZLFileImage("com/media/zlibrary/core/image/ZLFileImage");
JavaClass AndroidUtil::Class_ZLTextModel("com/media/zlibrary/text/model/ZLTextModel");
JavaClass AndroidUtil::Class_CachedCharStorageException("com/media/zlibrary/text/model/CachedCharStorageException");

JavaClass AndroidUtil::Class_Encoding("com/media/zlibrary/core/encodings/Encoding");
JavaClass AndroidUtil::Class_EncodingConverter("com/media/zlibrary/core/encodings/EncodingConverter");
JavaClass AndroidUtil::Class_JavaEncodingCollection("com/media/zlibrary/core/encodings/JavaEncodingCollection");

JavaClass AndroidUtil::Class_NativeFormatPlugin("com/media/dbstarplayer/formats/NativeFormatPlugin");
JavaClass AndroidUtil::Class_PluginCollection("com/media/dbstarplayer/formats/PluginCollection");
JavaClass AndroidUtil::Class_Paths("com/media/dbstarplayer/Paths");
JavaClass AndroidUtil::Class_Book("com/media/dbstarplayer/book/Book");
JavaClass AndroidUtil::Class_Tag("com/media/dbstarplayer/book/Tag");
JavaClass AndroidUtil::Class_NativeBookModel("com/media/dbstarplayer/bookmodel/NativeBookModel");
...
bool AndroidUtil::init(JavaVM* jvm) {
	...
	Constructor_ZLFileImage = new Constructor(Class_ZLFileImage, "(Ljava/lang/String;Lcom/media/zlibrary/core/filesystem/ZLFile;Ljava/lang/String;[I[I)V");
	...
	Method_Book_addTag = new VoidMethod(Class_Book, "addTag", "(Lcom/media/dbstarplayer/book/Tag;)");
	Method_Book_addUid = new VoidMethod(Class_Book, "addUid", "(Ljava/lang/String;Ljava/lang/String;)");

	StaticMethod_Tag_getTag = new StaticObjectMethod(Class_Tag, "getTag", Class_Tag, "(Lcom/media/dbstarplayer/book/Tag;Ljava/lang/String;)");
	...
	Method_NativeBookModel_setBookTextModel = new VoidMethod(Class_NativeBookModel, "setBookTextModel", "(Lcom/media/zlibrary/text/model/ZLTextModel;)");
	Method_NativeBookModel_setFootnoteModel = new VoidMethod(Class_NativeBookModel, "setFootnoteModel", "(Lcom/media/zlibrary/text/model/ZLTextModel;)");
	Method_NativeBookModel_addImage = new VoidMethod(Class_NativeBookModel, "addImage", "(Ljava/lang/String;Lcom/media/zlibrary/core/image/ZLImage;)");

/*
	Class_BookReadingException = new JavaClass(env, "com/media/dbstarplayer/bookmodel/BookReadingException");
