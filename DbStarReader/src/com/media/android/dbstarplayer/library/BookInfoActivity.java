...
package com.media.android.dbstarplayer.library;
...
import com.media.zlibrary.core.image.ZLLoadableImage;
import com.media.zlibrary.core.resources.ZLResource;
import com.media.zlibrary.core.language.Language;
import com.media.zlibrary.core.language.ZLLanguageUtil;

import com.media.android.dbstarplayer.R;
import com.media.zlibrary.ui.android.image.ZLAndroidImageData;
import com.media.zlibrary.ui.android.image.ZLAndroidImageManager;

import com.media.dbstarplayer.book.*;
import com.media.dbstarplayer.network.HtmlUtil;

import com.media.android.dbstarplayer.*;
import com.media.android.dbstarplayer.libraryService.BookCollectionShadow;
import com.media.android.dbstarplayer.preferences.EditBookInfoActivity;
...
public class BookInfoActivity extends Activity implements IBookCollection.Listener {
	...
	public static final String FROM_READING_MODE_KEY = "dbstarplayer.from.reading.mode";
	...
	protected void onCreate(Bundle icicle) {
		...
		Thread.setDefaultUncaughtExceptionHandler(
			new com.media.zlibrary.ui.android.library.UncaughtExceptionHandler(this)
		);
		...
		setupButton(R.id.book_info_button_open, "openBook", new View.OnClickListener() {
			public void onClick(View view) {
				if (myDontReloadBook) {
					...
					DbStarPlayer.openBookActivity(BookInfoActivity.this, myBook, null);
				}
			}
		});
			...
			public void onClick(View view) {
				OrientationUtil.startActivity(
					...
					new Intent(getApplicationContext(), EditBookInfoActivity.class)
						.putExtra(DbStarPlayer.BOOK_KEY, SerializerUtil.serialize(myBook))
				);
			}
		});
	...
	public static Intent intentByBook(Book book) {
		return new Intent().putExtra(DbStarPlayer.BOOK_KEY, SerializerUtil.serialize(book));
	}

	public static Book bookByIntent(Intent intent) {
		return intent != null ?
			SerializerUtil.deserializeBook(intent.getStringExtra(DbStarPlayer.BOOK_KEY)) : null;
	}
