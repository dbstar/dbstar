...
import com.media.dbstarplayer.network.tree.*;
import com.media.dbstarplayer.tree.FBTree;

import com.media.android.dbstarplayer.network.action.*;
...
public abstract class NetworkLibraryActivity extends TreeActivity<NetworkTree> implements ListView.OnScrollListener, NetworkLibrary.ChangeListener {
	static final String OPEN_CATALOG_ACTION = "android.dbstarplayer.action.OPEN_NETWORK_CATALOG";
