...
public abstract class Util implements UserRegistrationConstants {
	static final String AUTHORIZATION_ACTION = "android.dbstarplayer.action.network.AUTHORIZATION";
	static final String SIGNIN_ACTION = "android.dbstarplayer.action.network.SIGNIN";

	public static final String ADD_CATALOG_ACTION = "android.dbstarplayer.action.ADD_OPDS_CATALOG";
	public static final String ADD_CATALOG_URL_ACTION = "android.dbstarplayer.action.ADD_OPDS_CATALOG_URL";
	public static final String EDIT_CATALOG_ACTION = "android.dbstarplayer.action.EDIT_OPDS_CATALOG";
