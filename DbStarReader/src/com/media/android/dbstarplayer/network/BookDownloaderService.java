...
import com.media.dbstarplayer.network.urlInfo.BookUrlInfo;

import com.media.android.dbstarplayer.DbStarPlayer;

public class BookDownloaderService extends Service {
	public static final String BOOK_FORMAT_KEY = "com.media.android.dbstarplayer.network.BookFormat";
	public static final String REFERENCE_TYPE_KEY = "com.media.android.dbstarplayer.network.ReferenceType";
	public static final String CLEAN_URL_KEY = "com.media.android.dbstarplayer.network.CleanURL";
	public static final String TITLE_KEY = "com.media.android.dbstarplayer.network.Title";

	public static final String SHOW_NOTIFICATIONS_KEY = "com.media.android.dbstarplayer.network.ShowNotifications";
	...
	public void onStart(Intent intent, int startId) {
		...
		if (fileFile.exists()) {
			...
			doStop();
			startActivity(getDbStarPlayerIntent(fileFile));
			return;
		}
	...
	private Intent getDbStarPlayerIntent(final File file) {
		final Intent intent = new Intent(getApplicationContext(), DbStarPlayer.class);
		if (file != null) {
	...
	private Notification createDownloadFinishNotification(File file, String title, boolean success) {
		...
		final Intent intent = success ? getDbStarPlayerIntent(file) : new Intent();
