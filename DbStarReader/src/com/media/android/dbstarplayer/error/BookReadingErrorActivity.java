...
package com.media.android.dbstarplayer.error;
...
import com.media.zlibrary.ui.android.error.ErrorKeys;
import com.media.zlibrary.ui.android.error.ErrorUtil;
	...
	protected void onCreate(Bundle bundle) {
		...
		okButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "issues@dbstarplayer.org" });
				sendIntent.putExtra(Intent.EXTRA_TEXT, getIntent().getStringExtra(STACKTRACE));
				sendIntent.putExtra(Intent.EXTRA_SUBJECT, "DbStarPlayer " + new ErrorUtil(BookReadingErrorActivity.this).getVersionName() + " book reading issue report");
