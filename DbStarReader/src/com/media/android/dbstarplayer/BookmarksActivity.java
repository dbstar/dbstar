...
public class BookmarksActivity extends TabActivity implements MenuItem.OnMenuItemClickListener {
	...
	public void onCreate(Bundle bundle) {
		...
		myBook = SerializerUtil.deserializeBook(getIntent().getStringExtra(DbStarPlayer.BOOK_KEY));
	}
	...
	private void addBookmark() {
		final Bookmark bookmark =
			SerializerUtil.deserializeBookmark(getIntent().getStringExtra(DbStarPlayer.BOOKMARK_KEY));
		if (bookmark != null) {
	...
	private void gotoBookmark(Bookmark bookmark) {
		...
		if (book != null) {
			DbStarPlayer.openBookActivity(this, book, bookmark);
		} else {
