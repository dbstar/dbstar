...
public class ApiClientImplementation implements ServiceConnection, Api, ApiMethods {
	...
	private static final String ACTION_API = "android.dbstarplayer.action.API";
	static final String ACTION_API_CALLBACK = "android.dbstarplayer.action.API_CALLBACK";
	...
	private synchronized void checkConnection() throws ApiException {
		if (myInterface == null) {
			throw new ApiException("Not connected to DbStarPlayer");
		}
	}
	...
	public String getDbStarPlayerVersion() throws ApiException {
		return requestString(GET_DBSTARPLAYER_VERSION, EMPTY_PARAMETERS);
	}
