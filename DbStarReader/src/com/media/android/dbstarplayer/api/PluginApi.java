...
public abstract class PluginApi {
	public static final String ACTION_REGISTER = "android.dbstarplayer.action.plugin.REGISTER";
	public static final String ACTION_RUN = "android.dbstarplayer.action.plugin.RUN";
