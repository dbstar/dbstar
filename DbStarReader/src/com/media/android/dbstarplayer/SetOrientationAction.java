...
class SetScreenOrientationAction extends DbStarAndroidAction {
	...
	SetScreenOrientationAction(DbStarPlayer baseActivity, DbStarPlayerApp dbstarplayerapp, String optionValue) {
