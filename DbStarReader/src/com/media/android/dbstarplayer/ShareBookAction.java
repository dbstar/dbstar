...
public class ShareBookAction extends DbStarAndroidAction {
	ShareBookAction(DbStarPlayer baseActivity, DbStarPlayerApp dbstarplayerapp) {
	...
	protected void run(Object ... params) {
		DbStarUtil.shareBook(BaseActivity, Reader.Model.Book);
	}
}
