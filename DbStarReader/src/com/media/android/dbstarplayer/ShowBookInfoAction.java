...
class ShowBookInfoAction extends DbStarAndroidAction {
	ShowBookInfoAction(DbStarPlayer baseActivity, DbStarPlayerApp dbstarplayerapp) {
	...
	protected void run(Object ... params) {
		OrientationUtil.startActivity(
			...
			new Intent(BaseActivity.getApplicationContext(), BookInfoActivity.class)
				.putExtra(DbStarPlayer.BOOK_KEY, SerializerUtil.serialize(Reader.Model.Book))
