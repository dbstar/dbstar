...
abstract class PopupPanel extends ZLApplication.PopupPanel {
	...
	private volatile DbStarPlayer myActivity;
	private volatile RelativeLayout myRoot;

	PopupPanel(DbStarPlayerApp dbstarplayer) {
		super(dbstarplayer);
	}

	protected final DbStarPlayerApp getReader() {
		return (DbStarPlayerApp)Application;
	}
...
//		}
	...
	public void setPanelInfo(DbStarPlayer activity, RelativeLayout root) {
		myActivity = activity;
		myRoot = root;
	}

	public abstract void createControlPanel(DbStarPlayer activity, RelativeLayout root);
}
