...
import com.media.dbstarplayer.network.authentication.litres.LitResBookshelfItem;
import com.media.dbstarplayer.network.authentication.litres.LitResRecommendationsItem;
	...
	private String calculateEntryId(OPDSEntry entry) {
		...
		for (ATOMLink link : entry.Links) {
			...
			if (rel == null || rel.startsWith(REL_ACQUISITION_PREFIX)
					|| rel.startsWith(REL_DBSTARPLAYER_ACQUISITION_PREFIX)) {
