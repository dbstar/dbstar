...
import com.media.dbstarplayer.network.atom.ATOMConstants;

interface OPDSConstants extends ATOMConstants {
	// Feed level
	String REL_BOOKSHELF = "http://";
	String REL_RECOMMENDATIONS = "http://";
	String REL_TOPUP = "http://";
	...
	String REL_DBSTARPLAYER_ACQUISITION_PREFIX = "http://";
	...
	String REL_ACQUISITION_CONDITIONAL = "http://";
	String REL_ACQUISITION_SAMPLE_OR_FULL = "http://";
	...
	String REL_LINK_SIGN_IN = "http://";
	String REL_LINK_SIGN_OUT = "http://";
	String REL_LINK_SIGN_UP = "http://";
	String REL_LINK_TOPUP = "http://";
	String REL_LINK_RECOVER_PASSWORD = "http://";
}
