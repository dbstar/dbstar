...
public interface ActionCode {
	...
	String CHAPTER_BACK = "previousChapter";
	String CHAPTER_FORWARD = "nextChapter";
	String POPUP_VIEW_ACTION = "popupView";
	...
	String AUDIO_PLAY="audio_play";
	String AUDIO_PAUSE="audio_pause";
	String AUDIO_RESUME="audio_resume";
	String AUDIO_CANCEL="audio_cancel";
}
