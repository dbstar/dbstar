...
public final class ZLTextLineInfo {
	...
	public boolean isImageLine = false;
	public boolean isSideTextLine = false;
	ZLTextLineInfo(ZLTextParagraphCursor paragraphCursor, int elementIndex, int charIndex, ZLTextStyle style) {
		...
		ParagraphCursorLength = paragraphCursor!=null?paragraphCursor.getParagraphLength():0;
	...
	public boolean equals(Object o) {
		...
		return
			...
			(EndElementIndex==info.EndElementIndex)&&
			(EndCharIndex==info.EndCharIndex);
	}
