...
package com.media.zlibrary.ui.android.image;
					...
					switch (scaling) {
						...
						case FitMaximum:
						{
							...
							if (bWidth > 0 && bHeight > 0 &&
								...
								if(h>maxSize.Height){
									h=maxSize.Height;
									final Bitmap scaled2=Bitmap.createBitmap(scaled,0,0,w,h);
									if(scaled2!=null){
										scaled.recycle();
										scaled=null;
										myBitmap=scaled2;
								...
								if (scaled != null) {
									...
									bWidth == maxSize.Width&& bHeight>maxSize.Height){
								final Bitmap scaled=Bitmap.createBitmap(myBitmap,0,0,maxSize.Width,maxSize.Height);
								if (scaled != null) {
									myBitmap = scaled;
								}
							}
