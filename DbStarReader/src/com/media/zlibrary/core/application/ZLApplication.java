...
//		showExitConfirmDialog(((ZLAndroidLibrary)ZLAndroidLibrary.Instance()).getActivity());
		if (myWindow != null) {
			myWindow.close();
		}
	   ...
	   private void showExitConfirmDialog(Activity activity){
		   final AlertDialog.Builder builder = new AlertDialog.Builder(activity);
		   builder.setTitle(activity.getResources().getString(R.string.label_toast));
		   builder.setMessage(activity.getResources().getString(R.string.msg_exit_application));
		   builder.setPositiveButton(activity.getResources().getString(R.string.label_confirm), new DialogInterface.OnClickListener() {
		   ...
		   builder.setNegativeButton(activity.getResources().getString(R.string.label_cancel), new DialogInterface.OnClickListener() {
