...
public class CopyOfNewsPaperParser_bk {
    ...
    public static boolean lastCharisSymbol ;
    public static boolean isSpecial;
    public static boolean isLeftSymbol;
    public static boolean isRightSymbol;
                ...
                while(event!=XmlPullParser.END_DOCUMENT){
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if(TAG_PAGE_IMG.equals(tagName)){
                            ...
                            edition.PicPath = RootPath + edition.PicPath.substring(2, edition.PicPath.length());
                        }
                        break;
    ...
    public static NewsPaperArticleContent parseConfig(String path){
