 ...
 * Original file: C:\\LuoShidong\\Development\\dbstar\\DbstarDVB\\src\\com\\dbstar\\DbstarDVB\\PlayerService\\IPlayerService.aidl
 */
package com.dbstar.DbstarDVB.PlayerService;
public interface IPlayerService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.dbstar.DbstarDVB.PlayerService.IPlayerService
{
private static final java.lang.String DESCRIPTOR = "com.dbstar.DbstarDVB.PlayerService.IPlayerService";
...
/**
 * Cast an IBinder object into an com.dbstar.DbstarDVB.PlayerService.IPlayerService interface,
 * generating a proxy if needed.
 */
public static com.dbstar.DbstarDVB.PlayerService.IPlayerService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.dbstar.DbstarDVB.PlayerService.IPlayerService))) {
return ((com.dbstar.DbstarDVB.PlayerService.IPlayerService)iin);
}
return new com.dbstar.DbstarDVB.PlayerService.IPlayerService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.dbstar.DbstarDVB.PlayerService.MediaInfo _result = this.GetMediaInfo();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
{
data.enforceInterface(DESCRIPTOR);
com.dbstar.DbstarDVB.PlayerService.DivxInfo _result = this.GetDivxInfo();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_Set3Dviewmode:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.Set3Dviewmode(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_Set3Daspectfull:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.Set3Daspectfull(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_Set3Dswitch:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.Set3Dswitch(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_Set3Dgrating:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _result = this.Set3Dgrating(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
private static class Proxy implements com.dbstar.DbstarDVB.PlayerService.IPlayerService
{
...
@Override public int Open(java.lang.String filepath, int position) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public com.dbstar.DbstarDVB.PlayerService.MediaInfo GetMediaInfo() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.dbstar.DbstarDVB.PlayerService.MediaInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_GetMediaInfo, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.dbstar.DbstarDVB.PlayerService.MediaInfo.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.dbstar.DbstarDVB.PlayerService.DivxInfo GetDivxInfo() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.dbstar.DbstarDVB.PlayerService.DivxInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_GetDivxInfo, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.dbstar.DbstarDVB.PlayerService.DivxInfo.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public int SwitchAID(int id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int SwitchAudioChannel(int id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int SetColorKey(int color) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public void DisableColorKey() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public int GetOsdBpp() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int Seek(int time) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int Set3Dmode(int mode) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int Set3Dviewmode(int mode) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int Set3Daspectfull(int aspect) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int Set3Dswitch(int isOn) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int Set3Dgrating(int isOn) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int FastForward(int speed) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int BackForward(int speed) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int RegisterClientMessager(android.os.IBinder hbinder) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_Set3Dviewmode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_Set3Daspectfull = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_Set3Dswitch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_Set3Dgrating = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_FastForward = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_BackForward = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_RegisterClientMessager = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
}
...
public com.dbstar.DbstarDVB.PlayerService.MediaInfo GetMediaInfo() throws android.os.RemoteException;
public com.dbstar.DbstarDVB.PlayerService.DivxInfo GetDivxInfo() throws android.os.RemoteException;
