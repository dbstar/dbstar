...
typedef enum {
	...
	MOTHER_DISK_INITIALIZE_START	= 0x30018,	// 母盘初始化开始
	MOTHER_DISK_INITIALIZE_PROCESS	= 0x30019,	// 母盘初始化进度百分比
	MOTHER_DISK_INITIALIZE_FAILED	= 0x30020,	// 母盘初始化错误
	MOTHER_DISK_INITIALIZE_SUCCESS	= 0x30021,	// 母盘初始化成功
