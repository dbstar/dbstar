...
public class Utils {
	...
	public static boolean isWifiOnly(Context context) {
		 ...
		 * Context.CONNECTIVITY_SERVICE); return
		 * (cm.isNetworkSupported(ConnectivityManager.TYPE_MOBILE) == false);
		 */
	}
	...
	public static boolean setValue(String fileName, String value) {
		...
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(file), 32);
			try {
				out.write(value);
			} finally {
				out.close();
