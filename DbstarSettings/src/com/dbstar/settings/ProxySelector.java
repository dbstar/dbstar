...
public class ProxySelector extends Fragment implements DialogCreatable {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        final boolean userSetGlobalProxy = Utils.isUserSetGlobalProxy(dpm);
    ...
    void populateFields() {
        ...
        Utils.Proxy proxy = Utils.Proxy.getProxy(cm);
        if (proxy != null) {
...
//        cm.setGlobalProxy(p);
        ...
        Utils.Proxy.setProxy(cm, hostname, port, exclList);
