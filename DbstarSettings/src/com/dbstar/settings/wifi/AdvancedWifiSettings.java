...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    private void initPreferences() {
        ...
        if (Utils.WifiConfigure.isDualBandSupported(mWifiManager)) {
            frequencyPref.setOnPreferenceChangeListener(this);
//            int value = mWifiManager.getFrequencyBand();
            int value = Utils.WifiConfigure.getFrequencyBand(mWifiManager);
            if (value != -1) {
...
//                mWifiManager.setFrequencyBand(Integer.parseInt((String) newValue), true);
            	Utils.WifiConfigure.setFrequencyBand(mWifiManager, Integer.parseInt((String) newValue), true);
